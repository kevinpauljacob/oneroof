...
const PropertyDetails = ({ property }: Props) => {
  return (
    <>
        <div className='flex flex-col min-[1200px]:flex-row h-screen min-[1200px]:h-[85%] w-full min-[1200px]:w-[90%] 2xl:w-[80%]'>
                ...
                <div>
                    ...
                    <ul className='flex flex-col'>
                        ...
                        <li className='flex justify-between my-[2px]'>
                            ...
                            <div>
                                <span>{property.phonenumber.phonenumber}</span>
                            </div>
                        </li>
                        <li className='flex justify-between my-[2px]'>
                            <div className="flex items-center">
                            ...
                            <div>
                                <span>{property.phonenumber.landline}</span>
                            </div>
                        </li>
                    </ul>
                </div>
